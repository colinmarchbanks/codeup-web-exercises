...
var alamoPopup = new mapboxgl.Popup()
    .setHTML("<p style='font-size: large; color: red'>Remember The Alamo!</p>")
    .addTo(map);

marker2.setPopup(alamoPopup);
...
// geocode("131 Arvin Dr, San Antonio, Tx, 78209", mapboxToken).then(function (result) {
//     console.log(result);
...
//         .setHTML("<p style='color: purple'>My home!</p>");
//     marker3.setPopup(homePopup);
// });
...
// map.jumpTo([-98.439533,29.477157]);
