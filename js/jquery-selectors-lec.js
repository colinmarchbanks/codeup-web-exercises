...
$(document).ready(function() {
    ...
    $('#container').css({'color':'red','background-color':'green'});
    ...
    $('#mystery-genre,#book-bundle-one').css('background-color','orange');
    $('#science-fiction-genre,#book-bundle-three').css('background-color','blue')
    ...
    // TODO TOGETHER: Create a border around all elements
        ...
        $('*').css({'border':'1px solid black','font-family':'cursive'})
